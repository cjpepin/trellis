...
const { chunkNote } = require("../electron/lib/retrieval/chunkNote.ts");
const { searchRelevantNotes } = require("../electron/lib/retrieval/index.ts");
const database = require("../electron/lib/database.ts");
