...
export function CommandPalette({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center bg-black/45 px-4 pt-24">
          ...
          <Command.List className="max-h-[420px] overflow-y-auto px-2 py-2">
            ...
            <Command.Group heading="Navigate" className="px-2 py-1 text-xs text-trellis-faint">
              ...
              <Command.Item
                ...
                onSelect={() => {
                  setOpen(false);
                  navigate(appShellPath("/thoughts"));
                }}
              >
                Capture a thought
              </Command.Item>
