...
import type { WorkspaceInfo } from "@trellis/contracts";
...
export function WorkspaceChooser({ workspaces, onSelect }: Props) {
  return (
    <div
      className="flex min-h-full items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(200,169,110,0.18),_transparent_42%),linear-gradient(180deg,_rgba(18,18,18,0.98),_rgba(10,10,10,1))] px-6 py-12"
                ...
                <div className="mt-6 space-y-2 text-sm text-trellis-text">
                  <p>
                    {workspace.isPreview
                      ...
                      : "Your own buckets, account session, and live cloud chat."}
                  </p>
                  <p>
                    {workspace.localOnly
