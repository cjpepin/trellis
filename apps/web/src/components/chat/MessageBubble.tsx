  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      for (const artifact of artifacts) {
        ...
        const url = await resolveChatMediaDataUrl(artifact);
                              ...
                              <button
                                ...
                                onClick={() => {
                                  void (async () => {
                                    ...
                                    try {
                                      await window.trellis.bucket.appendChatImageToNote({
                                        bucketId,
                                        fileId: artifact.fileId,
                                        noteAssetsPath: artifact.noteAssetsPath
                                      });
                                        ...
                                        onClick={() => {
                                          void (async () => {
                                            ...
                                            try {
                                              ...
                                              const snapshot = await window.trellis.bucket.listIndex(
                                                bucketId
                                              );
                                              replaceIndex({
                                                notes: snapshot.notes,
