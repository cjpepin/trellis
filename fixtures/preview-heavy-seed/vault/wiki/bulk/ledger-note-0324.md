...
type: concept
---
Working memo 324 in a long-running vault. The graph stays navigable when each note stays small but points to a few stable neighbors like [[Ledger Note 0306]].
